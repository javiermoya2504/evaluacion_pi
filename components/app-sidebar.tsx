...
const navigation: NavigationItem[] = [
  {
    ...
    roles: ["admin", "coordinadora_pi", "jefe_asignatura", "profesor", "alumno"],
  },
  {
    name: "Rubricas",
    ...
    roles: ["admin", "coordinadora_pi", "jefe_asignatura", "profesor"],
  },
  {
    name: "Proyectos",
    ...
    roles: ["admin", "coordinadora_pi", "jefe_asignatura"],
  },
  {
    name: "Equipos",
  ...
  },
  {
    ...
    roles: ["admin", "coordinadora_pi", "profesor"],
  },
  {
